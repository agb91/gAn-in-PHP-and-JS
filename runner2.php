                ...
                <div class= "col-xs-12">
                    <div id = "verticalBlock" style = "display:block" class = "center" >
                            ...
                            <?php
                                ...
                                //the following row if you wanna more groups in the same analysis
                                // (maybe in the future will be)
                                //echoRootLike($runs, $allAnalyzesSingle);
                                
                                //the following is if you have only a group for each
                                //analysis (in december 2016 works in this way)

                				if ($cardinality == "multipleRange")
                				{
                					echoRootLikeMultiple($_POST["whichRun"], $whichRunSecond, $whichAnalysis);
                				}
                				else
                				{
                                ...
                                if($textMode=="on")
                                {
                                    echoRootLikeText($textFromTextMode , $whichAnalysis);   
                                }
