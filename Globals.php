...
$xmlConfigFilePath = "/opt/lampp/htdocs/test-interChangeble/gAn-SPERIMENTAL/AEgSettingsBAQ.xml"; // path of the ini file
$sourceRootPath = "/home/andrea/Downloads/buildRoot/bin/thisroot.sh"; //path of thisroot.sh
$gAnPath = "/opt/lampp/htdocs/test-interChangeble/gAn-SPERIMENTAL/"; //new path of gAn
$baseFolder = "/opt/lampp/htdocs/test-interChangeble/gAn-webFinal"; //basic folder that includes the project
$dirRawFiles = "/opt/lampp/htdocs/test-interChangeble/gAn-SPERIMENTAL/data/";
$allAnalyzesSingle = "/opt/lampp/htdocs/test-interChangeble/gAn-SPERIMENTAL/analyses/single_run";
$allAnalyzesMultiple = "/opt/lampp/htdocs/test-interChangeble/gAn-SPERIMENTAL/analyses/multi_run";
